...
public class ImplicareServlet extends HttpServlet
{
    ...
    {
        //Defini,c~ao da decodifica,c~ao da solicita,c~ao.
        ...
        //Testa se a solicitação ´e vazia ou nula.
        if(action == null || action.isEmpty())
        {throw new InvalidRequestException("Erro: nenhuma ação foi solicitada.");}
        
        /*
            Testa se a solicita,c~ao ´e v´alida, se ´e executa a solicit,c~ao,
            se n~ao redireciona para uma p´agina de erro.
        */
        switch (action) {
